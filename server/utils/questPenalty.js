...
export function buildStoredPenaltyForQuest(q) {
	...
	const table = {
		daily: {
			0: {
				str: {
					title: "Recovery Quest: Execute 30 push-ups in 3 sets of 10 with 90 seconds rest",
					howTo:
				...
				int: {
					title: "Recovery Quest: Write 250 words auditing yesterday's execution failures",
					howTo:
				...
				agi: {
					title: "Recovery Quest: 12-minute footwork drill — 40 high-knees × 4 rounds, 60s rest",
					howTo:
				...
				vit: {
					title: "Recovery Quest: Hydration and sleep log — 500ml water × 4 within 6 hours + bedtime",
					howTo:
			...
			1: {
				str: {
					title: "Recovery Quest: Execute 50 bodyweight squats + 30 push-ups in one session",
					howTo:
				...
				int: {
					title: "Recovery Quest: Execute 45-minute deep-work block on the linked goal only",
					howTo:
				...
				agi: {
					title: "Recovery Quest: 8,000 steps + 3×60s plank with 90s rest",
					howTo:
				...
				vit: {
					title: "Recovery Quest: Cold exposure 60s + 20-minute walk same day",
					howTo:
			...
			2: {
				str: {
					title: "Recovery Quest: Execute 100 burpees partitioned 5×20 with 120s between sets",
					howTo:
				...
				int: {
					title: "Recovery Quest: Produce 90-minute analysis — 600 words + 10 numbered sources",
					howTo:
				...
				agi: {
					title: "Recovery Quest: 5 km walk or jog continuous — no pauses over 60s",
					howTo:
				...
				vit: {
					title: "Recovery Quest: Zero alcohol/sugar today + 8 hours time-in-bed",
					howTo:
		...
		weekly: {
			0: {
				str: {
					title: "Recovery Quest: 4×45 min strength sessions this week (log each)",
					howTo:
				...
				int: {
					title: "Recovery Quest: 1,200 words + 1 scored self-test on the linked goal",
					howTo:
				...
				agi: {
					title: "Recovery Quest: 50,000 steps this week + 4 mobility sessions ×15 min",
					howTo:
				...
				vit: {
					title: "Recovery Quest: 7-day sleep window — same wake ±30 min + 7 logs",
					howTo:
			...
			1: {
				str: {
					title: "Recovery Quest: Weekly volume — 200 reps lower body + 150 reps upper in logs",
					howTo:
				...
				int: {
					title: "Recovery Quest: Ship one deliverable draft (≥2 hours) tied to the goal",
					howTo:
				...
				agi: {
					title: "Recovery Quest: 3×5 km sessions + 2×30 min skill footwork sessions",
					howTo:
				...
				vit: {
					title: "Recovery Quest: Meal prep 10 protein portions + alcohol-free week",
					howTo:
			...
			2: {
				str: {
					title: "Recovery Quest: 6×60 min training blocks + 1 test set (AMRAP or timed hold)",
					howTo:
				...
				int: {
					title: "Recovery Quest: 2,500-word execution memo + 60-minute teach-aloud recording",
					howTo:
				...
				agi: {
					title: "Recovery Quest: 30 km total running/walking + 4 hill repeats session",
					howTo:
				...
				vit: {
					title: "Recovery Quest: 10 nights in-bed ≥7.5h + daily veg servings tracked",
					howTo:
		...
		monthly: {
			0: {
				str: {
					title: "Recovery Quest: 16 hour-long workouts logged this month",
					howTo:
				...
				int: {
					title: "Recovery Quest: One 15-page equivalent deep dossier on the goal domain",
					howTo:
				...
				agi: {
					title: "Recovery Quest: 120 km locomotion this month (tracked)",
					howTo:
				...
				vit: {
					title: "Recovery Quest: 25 nights sleep log + monthly blood pressure 7-day average",
					howTo:
			...
			1: {
				str: {
					title: "Recovery Quest: Progressive test — start and end month strength benchmark",
					howTo:
				...
				int: {
					title: "Recovery Quest: 40 hours tracked on the linked goal in one timesheet",
					howTo:
				...
				agi: {
					title: "Recovery Quest: Complete one timed 10 km event + 8 weeks of 2 speed sessions/wk notes",
					howTo:
				...
				vit: {
					title: "Recovery Quest: Body comp or waist measure day 1 and day 28 + food log 20 days",
					howTo:
			...
			2: {
				str: {
					title: "Recovery Quest: 24 sessions ≥45 min + deload week protocol written",
					howTo:
				...
				int: {
					title: "Recovery Quest: Publish or share one artifact publicly (post, repo, or PDF)",
					howTo:
				...
				agi: {
					title: "Recovery Quest: Monthly mileage 200 km + longest single session 25 km",
					howTo:
						"Track monthly total ≥200 km. One outing ≥25 km continuous movement.",
					doneWhen: "Monthly export + long session note.",
				},
				vit: {
					title: "Recovery Quest: 30-day no-ultraprocessed challenge with daily photo log",
					howTo:
	...
	return {
		...
		whatYouImprove:
			"Recovery Quest protocol — execute fully, then mark this quest complete for standard XP. Main quest text is withheld until completion.",
	};
}
	...
	if (p && String(p.title || "").trim()) {
		...
		return {
			...
			whatYouImprove: String(
				p.whatYouImprove ||
					"Recovery Quest protocol — execute fully before marking this quest complete."
			).trim(),
		};
	}
